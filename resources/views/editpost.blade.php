                ...
                <section>
                    ...
                    <nav class="navbar " style=" font-size: 20px ">
                        <ul class="navbar-nav ">
                            ...
                            @else
                            You don't have permission to Edit post
                            @endrole
                        </ul>
                    </nav>
                    <nav class="navbar " style=" font-size: 20px ">
                        ...
                        <nav class="navbar navbar-expand-sm  sticky-top " style="background-color:black; ">
                            ...
                            <ul class="list-inline ml-auto mb-0">
                                <li class="list-inline-item ">
                                    <h3 class="text-light ml-center" id="head">Edit Post</h3>
                                </li>
                            </ul>
                            <ul class="list-inline ml-auto mb-0">
                                <li class="list-inline-item ">
                                            ...
                                            <div class="col-md-8">
                                                <div class="card">
                                                    <div class="card-header bg-primary text-center"
                                                        style="font-size: 25px;">{{ __('Edit Post') }}</div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form action="update" method="POST">
                                                            ...
                                                            <button type="submit" class="btn btn-primary px-3">Edit
                                                                Post</button>
                                                        </form>
                                                    </div>
                                                </div>
